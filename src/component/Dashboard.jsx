            ...
            <table className="min-w-full border border-gray-200 text-sm text-left">
                ...
                <tbody>
                    <tr className="hover:bg-gray-50">
                        <td className="px-4 py-2 border">Gacoan</td>
                        <td className="px-4 py-2 border">Es Milo</td>
                        <th className="px-4 py-2 borded">Keju udang</th>
                    ...
                    <tr className="hover:bg-gray-50">
                        ...
                        <th className="px-4 py-2 border">Sate</th>
